/*
 This loads the pathfinding layer
*/
/*
var pathfinding =         L.tileLayer('images/tiles/{z}/{x}/{y}.jpg', {
                                    minZoom: 0,
                                    maxZoom: 3,
                                    center: [0, 0],
                                    zoom: 1,
...
*/
var latlngs = [[11.77734375, 8.928487062665504],[74.95939165894974, -146.95312499999997]],
svg;

function p_load(){
    var polyline = L.polyline(latlngs, {weight: '10', color: 'red', fillOpacity: '1.0'   }).addTo(map);
      map.fitBounds(polyline.getBounds());
    
}

//removing the path if necessary
function unload_finder(map){
    svg.remove();
}

/*
 This function loads the finder and draws the path
 */
function load_finder(map){
    ...
    d3.json("scripts/path_d3.geojson", function(collection) {
            ...
            // way to do this!
            var originANDdestination = [featuresdata[0], featuresdata[4]]
